Learn how to modify aspects of the Obsidian appearance without needing to [develop a theme](Build%20themes.md).
...
- If you want more tips on styling Obsidian, refer to [Build themes](Build%20themes.md).
