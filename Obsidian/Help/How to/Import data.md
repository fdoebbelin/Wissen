...
> 5. Use our [Format converter](Format%20converter.md) to convert Roam Research's Markdown format into Obsidian's format.
...
If you're importing from Bear, the [Format converter](Format%20converter.md) plugin has an option to convert `::highlight::` to `==highlight==`.
...
In order to fix that, you can use our [Format converter](Format%20converter.md) to convert your Zettelkasten links into either `[[202001010000 My Note]]` or `[[202001010000 My Note|My Note]]`.

You might also be interested in the [Unique note creator](Unique%20note%20creator.md) plugin.
